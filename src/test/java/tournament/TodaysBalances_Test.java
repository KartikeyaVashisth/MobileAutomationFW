...
public class TodaysBalances_Test extends Recovery {
	...
	public void TB2_test() throws Exception{
		...
		Commentary.log(LogStatus.INFO, "["+h.getEngine()+"]: Add an expense transaction for a manual checking account, verify checking & total balance on overview screen accounts card.");
	...
	public void TB3_test() throws Exception{
		...
		Commentary.log(LogStatus.INFO, "["+h.getEngine()+"]: Add an income transaction for a manual checking account, verify checking & total balance on overview screen accounts card.");
		String sChecking_before, sTotal_before, sChecking_after, sTotal_after;
	...
	public void TB4_test() throws Exception{
		...
		Commentary.log(LogStatus.INFO, "["+h.getEngine()+"]: Add an expense transaction for a manual Credit card account, verify Credit card & total balance on overview screen accounts card.");
	...
	public void TB5_test() throws Exception{
		...
		Commentary.log(LogStatus.INFO, "["+h.getEngine()+"]: Add an income transaction for a manual Credit card account, verify credit cards & total balance on overview screen accounts card.");
		String sCC_before, sTotal_before, sCC_after, sTotal_after;
	...
	public void TB6_test() throws Exception{
		...
		Commentary.log(LogStatus.INFO, "["+h.getEngine()+"]: Add an expense transaction for a manual Cash account, verify Cash & total balance on overview screen accounts card.");
	...
	public void TB7_test() throws Exception{
		...
		Commentary.log(LogStatus.INFO, "["+h.getEngine()+"]: Add an Income transaction for a manual CASH account, verify CASH & total balance on overview screen accounts card.");
		String sBefore, sTotal_before, sAfter, sTotal_after;
	...
	public void TB8_test() throws Exception{
		...
		Commentary.log(LogStatus.INFO, "["+h.getEngine()+"]: Add an expense transaction for a manual SAVING account, verify SAVINGS & total balance on overview screen accounts card.");
		String sBefore, sTotal_before, sAfter, sTotal_after;
	...
	public void TB9_test() throws Exception{
		...
		Commentary.log(LogStatus.INFO, "["+h.getEngine()+"]: Add an income transaction for a manual SAVINGS account, verify SAVINGS & total balance on overview screen accounts card.");
		String sBefore, sTotal_before, sAfter, sTotal_after;
