...
public class ScheduledTransactionsTest_3 extends Recovery {
	...
	public String getUsername_basedOnEnv() throws Exception{
		...
		un.stage_ios = "st_3_ios++@stage.com";
		un.stage_android = "st_3_android++@stage.com";
	...
	public void ST21_Test() throws Exception {
		...
		Verify.waitForObject(bi.editButton, 1);
		bi.editButton.click();
		...
		bi.backButtonOfViewSeriesPage.click();
...
//		op.scrollToTop();
		...
		int todaysBalanceCompare_WithReminderFilterOFF = Double.compare(dTodaysBalance_WithReminderFilterOFF-d, dTodaysBalance_WithReminderFilterOFF_AfterEntering);
		int projectedBalanceCompare_WithReminderFilterOFF = Double.compare(dProjectedBalance_WithReminderFilterOFF-d, dProjectedBalance_WithReminderFilterOFF_AfterEntering);
...
//		if(dProjectedBalance_With7DaysReminderFilter-d==dProjectedBalance_With7DaysReminderFilter_AfterEntering)
		if(projectedBalanceCompare_With7DaysReminderFilter_AfterEntering == 0)
			Commentary.log(LogStatus.INFO, "PASS: As Expected, Projected balance after entering the reminder with Next 7 Days filter is: "+sProjectedBalanceWith7DaysReminderFilter_AfterEntering+".");
		else
			Commentary.log(sa, LogStatus.FAIL, "FAIL: Projected balance after entering the reminder with Next 7 Days filter is NOT correct.");
	...
	public void ST24_Test() throws Exception {
		...
		Integer todaysBalanceCompare_WithReminderFilterOFF_AfterEntering = Double.compare(dTodaysBalance_WithReminderFilterOFF-d*3d, dTodaysBalance_WithReminderFilterOFF_AfterEntering);
		Integer projectedBalanceCompare_WithReminderFilterOFF_AfterEntering = Double.compare(dProjectedBalance_WithReminderFilterOFF-d*3d, dProjectedBalance_WithReminderFilterOFF_AfterEntering);
...
//		if(dProjectedBalance_WithReminderFilterOFF-d*3d==dProjectedBalance_WithReminderFilterOFF_AfterEntering)
	...
	public void ST25_Test() throws Exception {
		...
		Integer todaysBalanceCompare_With7DaysReminderFilter_AfterIgnoring = Double.compare(dTodaysBalance_With7DaysReminderFilter+d, dTodaysBalance_With7DaysReminderFilter_AfterIgnoring);
		Integer projectedBalanceCompare_With7DaysReminderFilter_AfterIgnoring = Double.compare(dProjectedBalance_With7DaysReminderFilter+d, dProjectedBalance_With7DaysReminderFilter_AfterIgnoring);
...
//		if(dProjectedBalance_With7DaysReminderFilter+d==dProjectedBalance_With7DaysReminderFilter_AfterIgnoring)
	...
	public void ST26_Test() throws Exception {
		...
		Integer todaysBalanceCompare_With7DaysReminderFilter_AfterIgnoring = Double.compare(dTodaysBalance_With7DaysReminderFilter+d*3d, dTodaysBalance_With7DaysReminderFilter_AfterIgnoring);
		Integer projectedBalanceCompare_With7DaysReminderFilter_AfterIgnoring = Double.compare(dProjectedBalance_With7DaysReminderFilter+d*3d, dProjectedBalance_With7DaysReminderFilter_AfterIgnoring);
